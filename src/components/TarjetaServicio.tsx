...
const TarjetaServicio: React.FC<Props> = ({ servicio }) => {
  return (
    <div className="tarjeta-servicio-contenedor">
      <div className="tarjeta-servicio-imagen">
        <img src={servicio.imagen} alt={servicio.titulo} />

        <button className="tarjeta-servicio-favorito">
        ...
        {servicio.esNuevo && <span className="tarjeta-servicio-etiqueta">Nuevo</span>}
      </div>

      <div className="tarjeta-servicio-informacion">
        <p className="tarjeta-servicio-nombre">{servicio.titulo}</p>
        <p className="tarjeta-servicio-precio">{servicio.precio}</p>

        <p className="tarjeta-servicio-calificacion">
          {servicio.calificacion}
          <span className="tarjeta-servicio-estrellas">★★★★★</span>
          ({servicio.opiniones})
        </p>
      </div>
    </div>
