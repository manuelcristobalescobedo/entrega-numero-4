export default function Encabezado() {
    return (
        <header className="encabezado-contenedor">
            <a className="encabezado-logotipo">
            ...
            <form className="encabezado-busqueda">
                <input className="encabezado-buqueda-entrada" id="busqueda" type="search" placeholder="Buscar"></input>
                <button className="encabezado-busqueda-boton" id="enviar" type="submit"></button>
            </form>
            <div className="encabezado-acciones">
                <button className="encabezado-boton-primario">Registrarse</button>
                <button className="encabezado-boton-secundario">Ingresar</button>
            </div> 
        </header>
    );
}